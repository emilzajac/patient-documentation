...
public class UserRestExceptionHandler {
    ...
    public UserRestExceptionHandler(ExceptionsUtils exceptionsUtils) {
        this.exceptionsUtils = exceptionsUtils;
    }

    @ExceptionHandler({UserException.class})
    public ResponseEntity<ApiError> createApiResponse(UserException exception) {
        ApiError apiError = exceptionsUtils.createApiError(exception, exception.getStatusCode(), "Bład tworzenia konta", exception.getMessage());
